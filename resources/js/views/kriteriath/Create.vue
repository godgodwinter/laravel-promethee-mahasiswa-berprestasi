                    ...
                    <hr>
                        ...
                        <form action="#" method="POST" @submit.prevent="store">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" v-model="form.nilai" id="Input-nilai" class="form-control">
...
export default {
    ...
    methods:{
        ...
        async store(){
            this.loading=true;
        try{
            let response = await axios.post('/api/kriteriath/store', this.form)
            if(response.status==200){
                // console.log(response.data);
                this.form.nama=""
                this.form.nilai=""
            ...
            this.$router.push(`/kriteriath/table/${this.$route.params.id}`)
            }
